...
class TodoApp {
  ...
  constructor() {
    ...
    this.#inputNewTodo.addEventListener(
      "keydown",
      this.#handleKeyDownToCreateNewTodo.bind(this), //need to explicitly bind to this (TodoApp) to get access to the private fields of TodoApp
    );
...
//   // if this #handleKeyDownToCreateNewTodo is declared as as an arrow function: 
//   #handleKeyDownToCreateNewTodo = (event) => {
//     if (event.key === "Enter") {
//       const todoText = event.target.value.trim();
//       if (todoText) {
...
//     }
//   }
// // we do not need to explicitly bind, and this will work
// this.#inputNewTodo.addEventListener(
//     "keydown",
//     this.#handleKeyDownToCreateNewTodo,
//   );
// This is because arrow functions inherit "this" from the surrounding lexical context, i.e. the context where the 
// function was created, i.e. TodoApp class context
